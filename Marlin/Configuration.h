...
#define STRING_CONFIG_H_AUTHOR "(Vladimir Sitnikov)" // Who made the changes.
...
#define XRB2_NOZZLE_TO_PROBE_OFFSET_INDUCTIVE { 31, 6, -0.94 }
#define XRB2_NOZZLE_TO_PROBE_OFFSET_BLTOUCH { 31, 6, -0.94 }
#define XRB2_NOZZLE_TO_PROBE_OFFSET_BLTOUCH_INFRONT { -1, -26, -2 }
#define XRB2_NOZZLE_TO_PROBE_OFFSET_BLTOUCH_ENOT { 31, 6, -0.94 }

#if ENABLED(FIX_MOUNTED_PROBE)
  #undef NOZZLE_TO_PROBE_OFFSET
  #define NOZZLE_TO_PROBE_OFFSET XRB2_NOZZLE_TO_PROBE_OFFSET_INDUCTIVE
#elif ENABLED(BLTOUCH)
  #undef NOZZLE_TO_PROBE_OFFSET
  #define NOZZLE_TO_PROBE_OFFSET XRB2_NOZZLE_TO_PROBE_OFFSET_BLTOUCH
#endif
 ...
 */
#define Z_IDLE_HEIGHT Z_MAX_POS-1
...
#define X_SCREW_OFFSET ((X_BED_SIZE - 260)/2)
#define Y_SCREW_OFFSET ((Y_BED_SIZE - 225)/2)
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  // #define FILAMENT_RUNOUT_SCRIPT "M25" //LVGL
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { X_SCREW_OFFSET, Y_SCREW_OFFSET, X_SCREW_OFFSET, Y_SCREW_OFFSET } // (mm) Left, Front, Right, Back insets
  #if ENABLED(PROBE_MANUALLY)
    // Allow user to put paper or a feeler gauge under the nozzle
    #define BED_TRAMMING_HEIGHT      0.1        // (mm) Z height of nozzle at tramming points
  #else
    // Probe does not need a paper for the measurements
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MIN_POS), 3 }
