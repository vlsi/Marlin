...
#define Z_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.(自动调平常闭、常开调整，同时调)
...
#define Z_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.(自动调平常闭、常开调整，同时调)
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.(自动调平常闭、常开调整，同时调)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 160, 420 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 45, 45 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 3500, 3500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 6, 0 ,-0.1 } //{自动调平和喷嘴X偏移值，自动调平和喷嘴Y轴偏移值，自动调平和喷嘴Z轴偏移值，....}
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                PE7 // LED driving pin
