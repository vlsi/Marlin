...
#define FOODLIGHT_IT                   "Floodlight"
#define Conveyor_belt_IT               "conveyor belt moves on"
#define Conveyor_is_backing_IT          "conveyor is backing up"
