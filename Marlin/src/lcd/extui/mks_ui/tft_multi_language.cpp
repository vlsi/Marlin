...
advanced_menu_def advanced_menu;
...
// wifi-list
    ...
    case LANG_SIMPLE_CHINESE:
        ...
        printing_MENU.times = PRINT_TIMES_CN;
        printing_MENU.print_times = PRINT_PRINT_TIMES_CN;
...
//
        ...
        tool_menu.Conveyor = Conveyor_CN;
        ...
        leveling_menu.manual        = LEVELING_MANUAL_TEXT_CN;
        leveling_menu.auto_level    = LEVELING_AUTO_TEXT_CN;
        leveling_menu.if_zero       = LEVELING_IF_ZERO_CN;
        leveling_menu.homing        = LEVELING_HOMING_CN;
        leveling_menu.level_failed  = LEVELING_FAILED_CN;
        leveling_menu.if_calibrate  = LEVELING_IF_CALIBRATE_CN;
        leveling_menu.leve_tip      = LEVELING_LEVEL_TIP_CN;
        leveling_menu.start         = LEVELING_START_CN;
        leveling_menu.waiting       = LEVELING_WAITING_CN;
...
//
        ...
        tool_menu.Conveyor = Conveyor_T_CN;
        ...
        leveling_menu.manual        = LEVELING_MANUAL_TEXT_T_CN;
        leveling_menu.auto_level    = LEVELING_AUTO_TEXT_T_CN;
        leveling_menu.if_zero       = LEVELING_IF_ZERO_T_CN;
        leveling_menu.homing        = LEVELING_HOMING_T_CN;
        leveling_menu.level_failed  = LEVELING_FAILED_T_CN;
        leveling_menu.if_calibrate  = LEVELING_IF_CALIBRATE_T_CN;
        leveling_menu.leve_tip      = LEVELING_LEVEL_TIP_T_CN;
        leveling_menu.start         = LEVELING_START_T_CN;
        leveling_menu.waiting       = LEVELING_WAITING_T_CN;
    ...
    case LANG_ENGLISH:
        ...
        printing_MENU.times = PRINT_TIMES_EN;
        printing_MENU.print_times = PRINT_PRINT_TIMES_EN;
//
#if ENABLED(MKS_WIFI_MODULE)
        // tips
        tips_menu.joining = TEXT_WIFI_JOINING_EN;
        ...
        tool_menu.Conveyor = Conveyor_EN;
        ...
        leveling_menu.manual        = LEVELING_MANUAL_TEXT_EN;
        leveling_menu.auto_level    = LEVELING_AUTO_TEXT_EN;
        leveling_menu.if_zero       = LEVELING_IF_ZERO_EN;
        leveling_menu.homing        = LEVELING_HOMING_EN;
        leveling_menu.level_failed  = LEVELING_FAILED_EN;
        leveling_menu.if_calibrate  = LEVELING_IF_CALIBRATE_EN;
        leveling_menu.leve_tip      = LEVELING_LEVEL_TIP_EN;
        leveling_menu.start         = LEVELING_START_EN;
        leveling_menu.waiting       = LEVELING_WAITING_EN;
        //
    ...
    case LANG_RUSSIAN:
        ...
        tool_menu.Conveyor = Conveyor_RU;
        ...
        leveling_menu.manual        = LEVELING_MANUAL_TEXT_RU;
        leveling_menu.auto_level    = LEVELING_AUTO_TEXT_RU;
        leveling_menu.if_zero       = LEVELING_IF_ZERO_RU;
        leveling_menu.homing        = LEVELING_HOMING_RU;
        leveling_menu.level_failed  = LEVELING_FAILED_EN;
        leveling_menu.if_calibrate  = LEVELING_IF_CALIBRATE_RU;
        leveling_menu.leve_tip      = LEVELING_LEVEL_TIP_RU;
        leveling_menu.start         = LEVELING_START_RU;
        leveling_menu.waiting       = LEVELING_WAITING_RU;
        //
...
//
        ...
        tool_menu.Conveyor = Conveyor_SP;
...
//
        ...
        tool_menu.Conveyor = Conveyor_FR;
...
//
        ...
        tool_menu.Conveyor = Conveyor_IT;
