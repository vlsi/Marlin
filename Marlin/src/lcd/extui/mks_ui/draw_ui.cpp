...
void gCfgItems_init()
{
    ...
    gCfgItems.floodlight_state = true;
    gCfgItems.conveyor_belt_state = true;
    gCfgItems.conveyor_backing_state = true;
...
void tft_style_init()
{
    ...
    lv_style_copy(&label_dialog_black, &tft_style_preHeat_label_BLACK);
    label_dialog_black.text.color = LV_COLOR_BLACK;
    label_dialog_black.text.font = &lv_font_roboto_16;
...
void gcode_preview(char *path, int xpos_pixel, int ypos_pixel)
{
    ...
    for (i = 0; i < 400; i += 2)
    {
        ...
        if (*p_index == 0x0000)
            *p_index = LV_COLOR_WHITE.full; // LV_COLOR_BACKGROUND.full; LV_COLOR_WHITE
    }
