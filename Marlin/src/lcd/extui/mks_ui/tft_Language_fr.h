...
#define FOODLIGHT_FR                    "Floodlight"
#define Conveyor_belt_FR                "conveyor belt moves on"
#define Conveyor_is_backing_FR          "conveyor is backing up"
