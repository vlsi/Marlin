...
#define LEVELING_START_T_CN           "開始"
#define LEVELING_WAITING_T_CN         "等待"
#define LEVELING_MANUAL_TEXT_T_CN     "手動調平"
#define LEVELING_AUTO_TEXT_T_CN       "自動調平"
#define LEVELING_IF_ZERO_T_CN         "點擊后印表機將回原點，是否繼續？"
#define LEVELING_HOMING_T_CN          "返回原點過程中，請等待"
#define LEVELING_IF_CALIBRATE_T_CN    "是否校准列印平臺？"
#define LEVELING_LEVEL_TIP_T_CN       "    注意噴嘴和平臺之間的距離\n    （大約是一張A4紙的厚度），\n你可以用Z-偏移量向上或向下調整。"
#define LEVELING_FAILED_T_CN          "調平失敗"
