...
#define FOODLIGHT_RU                    "Floodlight"
#define Conveyor_belt_RU                "conveyor belt moves on"
#define Conveyor_is_backing_RU          "conveyor is backing up"
...
#define LEVELING_MANUAL_TEXT_RU         "Руководство"
#define LEVELING_AUTO_TEXT_RU           "Авто"
#define LEVELING_IF_ZERO_RU             "Печатающая головка вернется в исходное\n положение. Вы хотите продолжить?"
#define LEVELING_HOMING_RU              "Возвращение в исходное положение.\n Пожалуйста, подождите."
#define LEVELING_IF_CALIBRATE_RU        "Калибровать платформу"
#define LEVELING_LEVEL_TIP_RU           "Обратите внимание на расстояние между соплом и платформой\n (примерно равно толщине листа бумаги формата А4), \nвы можете отрегулировать его выше или ниже с \nпомощью смещения по оси Z"
#define LEVELING_START_RU               "Начать"
#define LEVELING_WAITING_RU             "Подождите"