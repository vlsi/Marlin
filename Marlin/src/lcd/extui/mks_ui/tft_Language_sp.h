...
#define FOODLIGHT_SP                    "Floodlight"
#define Conveyor_belt_SP                "conveyor belt moves on"
#define Conveyor_is_backing_SP          "conveyor is backing up"
