...
#define FOODLIGHT_CN                  "灯带"
#define Conveyor_belt_CN              "传送带移动"
#define Conveyor_is_backing_CN        "传送带往回移动"
...
#define PRINT_TIMES_CN          "次数"
#define PRINT_PRINT_TIMES_CN "打印次数"

#define LEVELING_START_CN           "开始"
#define LEVELING_WAITING_CN         "等待"
#define LEVELING_MANUAL_TEXT_CN     "手动调平"
#define LEVELING_AUTO_TEXT_CN       "自动调平"
#define LEVELING_IF_ZERO_CN         "点击后打印机将回原点，是否继续？"
#define LEVELING_HOMING_CN          "返回原点过程中，请等待"
#define LEVELING_IF_CALIBRATE_CN    "是否校准打印平台？"
#define LEVELING_LEVEL_TIP_CN       "    注意喷嘴和平台之间的距离\n    （大约是一张A4纸的厚度），\n你可以用Z-偏移量向上或向下调整。"
#define LEVELING_FAILED_CN          "调平失败"