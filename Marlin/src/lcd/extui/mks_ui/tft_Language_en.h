...
#define FOODLIGHT_EN                    "Floodlight"
#define Conveyor_belt_EN                "conveyor belt moves on"
#define Conveyor_is_backing_EN          "conveyor is backing up"
...
#define PRINT_TIMES_EN          "Times"
#define PRINT_PRINT_TIMES_EN    "print times"


#define LEVELING_START_EN           "Start"
#define LEVELING_WAITING_EN         "Waiting"
#define LEVELING_MANUAL_TEXT_EN     "Manual"
#define LEVELING_AUTO_TEXT_EN       "Auto"
#define LEVELING_IF_ZERO_EN         "The print head will return to the home\n position. Do you want to continue?"
#define LEVELING_HOMING_EN          "Return to home position. Please wait."
#define LEVELING_IF_CALIBRATE_EN    "Whether to calibrate the platform."
#define LEVELING_LEVEL_TIP_EN       "Note the distance between the nozzle\n and the platform (about the thickness of\n a sheet of A4 paper), which you can\n adjust up or down using the Z-offset"
#define LEVELING_FAILED_EN          "Auto leveling failed"